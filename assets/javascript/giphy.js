        ...
        $("#submitBtn").on("click", function (event) {
            ...
            var attrValues = {
                Id: BtnId,
                value: animaArray[displayList],
                name: animaArray[displayList]
            }
            inputBtn.attr(attrValues);
            //console.log(attrValues.Id);
            ...
            //attach a click event to the button upon its creation
            // and call getGiphy function
